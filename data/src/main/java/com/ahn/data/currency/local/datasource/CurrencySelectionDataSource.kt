...
import com.ahn.data.di.CurrencySelectionPreferencesDataStore
...
class CurrencySelectionDataSource @Inject constructor(
    @param:CurrencySelectionPreferencesDataStore private val dataStore: DataStore<Preferences>,
) {
    ...
    /**
     * DataStore 읽기 중 [IOException]이 발생하면 빈 Preferences를 방출해 Flow를 복구합니다.
     *
     * IO 오류가 아닌 예외는 그대로 다시 던집니다.
     */
